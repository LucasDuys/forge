...
- **Verification checks the spec, not the checklist.** Four levels: existence → substantive (not a stub) → wired (imported where used) → runtime (tests pass, CI green). ([docs/verification.md](docs/verification.md))
